...
class HangmanGame(AbstractGame):
    ...
    def display_result(self):
        if len(self._incorrect_guesses) >= self._max_attempts:
            ...
            self.score += 1  # Increment score for each word guessed correctly
    ...
    def input_username(self):
        ...
        if username.isalnum():
            ...
            print(f"Username {self.player_username} saved! You got {self.score} points!")  # Updated to display total score
        else:
    ...
    def reset_game(self):
        ...
        self._incorrect_guesses.clear()
        self._win_status = 0
        self.score = 0  # Reset score if needed to start a new game
